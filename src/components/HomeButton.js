...
function HomeButton({ icon }) {
    ...
    <a href={"https://www.uog.edu/research/university-libraries-digital-team"}>
        <div onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} style={{backgroundColor: color, height: "100px", width: "100px", position: "absolute", bottom: mobileDeviceMaxHeight ? "0" : mediumDeviceMaxHeight ? "5%" : "7vh", left: mobileDevice ? "72.5%" : mediumDevice ? "80%" : "80vw", borderRadius: "75px", display: "flex", justifyContent: "center", alignItems: "center"}}>
                {icon}
        </div>
    </a>
    </>
